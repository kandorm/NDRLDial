...
from DRLPolicy.policy.Policy import Policy, TerminalState, TerminalAction
from DRLPolicy.policy.gp.GPLib import GPSARSA, GPState, GPAction, Kernel, TerminalGPState, TerminalGPAction
...
class GPPolicy(Policy):
    ...
    def __init__(self, learning, in_policy_file, out_policy_file):
        ...
        self.replace = {}
        self.slot_abstraction_file = 'DRLPolicy/policy/slot_abstractions/CamRestaurants.json'
